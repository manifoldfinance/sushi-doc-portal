        ...
        <section className={styles.footerTopBorder}>
            ...
            <div className={clsx('page-container', styles.afterFooter)}>
                <div className={styles.footerLogoContainer}>
                    ...
                    <span>&#169; {new Date().getFullYear()} Sushiswap Community - CC4.0 </span>
                </div>
                <a href="https://etherscan.io/address/0x11Ca5375AdAfd6205E41131A4409f182677996E6#readContract" target="_blank">BoringHelperV2</a>
                <a href="" target="_blank">Made with 🍣 Tsukiji Fish Market</a>
            </div>
        </section>
    );
}
