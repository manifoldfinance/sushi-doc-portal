...
const DeveloperList = [
    {
        ...
        description: (
            <>
                Incentivizing protocols and liquidity by rebates and discounts for increasing volume and
                protocol TVL.
            </>
        )
    },
    {
        ...
        description: (
            <>
                Launch a new strategy today and get a percentage of the strategies harvest upfront, today.
            </>
        )
    },
];
