...
const FeatureList = [
    {
        title: 'Onsen Bar',
        description: 'Onsen aims to bring new liquidity to SushiSwap, decrease slippage, expand our pool offerings, and foster exciting synergistic partnerships with other DeFi projects.',
        image: (
            <div className={clsx(styles.featureCardImage, styles.onsenImage)}/>
        ),
        links: [
            {
                title: 'Introduction',
    ...
    {
        title: 'Bentobox',
        description: 'BentoBox is a token vault that generates yield for the capital deposited into it. The vault uses low-risk farming strategies and is the foundation for all of Sushis financial instruments',
        image: (
    ...
    {
        title: 'MiSO',
        description: 'MISO is a suite of open-source smart contracts created to ease the process of launching a new project on the Sushi. MISO aims to be the place for token creators and communities to launch new project tokens. ',
        image: (
