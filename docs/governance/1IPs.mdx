...
# 1IPs
This section tracks all 1IPs that have made it to the [Phase-4: Snapshot Vote](https://docs.manifoldfinance.com/docs/governance/proposal-lifecycle#phase-4-snapshot-vote) of the Proposal Lifecycle. 
...
### [1IP-05] Add Derivative Aggregation to Manifold Finance 
...
* **[Phase-3: Temperature Check](https://gov.manifoldfinance.com/t/1ip-05-add-derivative-aggregation-to-1inch-network/2828)**
...
<h2>Specification</h2>
<p>This proposal serves as a signal from the Manifold Finance DAO to the 1inch Foundation and 1inch Labs. Once passed, the Manifold Finance DAO calls for the 1inch Foundation to allot resources to add derivative aggregation to the 1inch Protocol and dApp, and for 1inch Labs to add derivative aggregation to the 1inch smart contracts and 1inch API.</p>
...
* **[Phase-3: Temperature Check](https://gov.manifoldfinance.com/t/1ip-3-formalization-vote-to-make-1inch-deflationary/2103)**
...
* **[Phase-3: Temperature Check](https://gov.manifoldfinance.com/t/1ip-1-1inch-trading-incentives-v1-0/2004)**
