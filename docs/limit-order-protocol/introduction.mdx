...
1inch users can place their limit orders via 1inch [dApp](https://app.manifoldfinance.com/#/1/limit-order/WETH/DAI).
...
-   You can use it right in [1inch dApp](https://app.manifoldfinance.com/#/1/limit-order/WETH/DAI)
